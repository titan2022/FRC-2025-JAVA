...
public class CoralScorerSubsystem extends SubsystemBase {
  ...
  private static final double MOVE_CORAL_SPEED = 3; // in volts
  private static final double SCORE_CORAL_SPEED = 3; // in volts
  private static final long SCORE_CORAL_TIMEOUT = 1 * 1000000; // microseconds
  private static final long INDEX_CORAL_TIMEOUT = 4 * 150000; // microseconds
  ...
  public void scoreCoral(boolean isReversed) {
    ...
    scoringMotor.setVoltage(SCORE_CORAL_SPEED * (isReversed ? -0.4 : 1));
  }
