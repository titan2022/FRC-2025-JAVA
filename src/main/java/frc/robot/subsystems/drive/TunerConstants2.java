...
public class TunerConstants2 {
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.30322265625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.468017578125);
