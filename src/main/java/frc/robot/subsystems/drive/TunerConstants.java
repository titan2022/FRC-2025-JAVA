...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(90).withKI(0).withKD(0.8)
        .withKS(0).withKV(0.0).withKA(0.0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.13713).withKI(0).withKD(0.00)
        .withKS(0.22487).withKV(0.11236);
    ...
    private static final Distance kWheelRadius = Inches.of(1.930); // 1.955: undershot // 1.935: overshot // 1.930, 1.925: new threads, overshot
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.326416015625); // 0.316650390625
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.170654296875); // 0.12890625
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.476806640625); // 0.471435546875
