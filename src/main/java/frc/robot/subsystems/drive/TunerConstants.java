...
public class TunerConstants {
    ...
    public static final double MAX_ANGULAR_SPEED = 1; // rad/s
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        ...
        .withKS(0.1).withKV(5.21).withKA(0)
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(1.39);

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 0;

    private static final double kDriveGearRatio = 23;
    private static final double kSteerGearRatio = 42;
