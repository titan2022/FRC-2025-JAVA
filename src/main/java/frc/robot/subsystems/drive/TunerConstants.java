...
public class TunerConstants {
    ...
    public static final double MAX_ANGULAR_SPEED = 400.0 * frc.robot.utility.Constants.Unit.DEG; // rad/s
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(160).withKI(0).withKD(0.3)
        .withKS(0).withKV(0.0).withKA(0.0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(14).withKI(0.0).withKD(0.0)
        .withKS(5.4854).withKV(0.072502).withKA(0.43636);
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.029);
    ...
    private static final Distance kWheelRadius = Meters.of(0.050115); // 1.955: undershot // 1.935: overshot // 1.930, 1.925: new threads, overshot
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.4521484375); // 0.448974609375
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.33154296875); // 0.316650390625
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.125732421875); // 0.12890625
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.473388671875); // 0.471435546875
