...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    // Based on https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/SwerveWithPathPlanner/src/main/java/frc/robot/subsystems/CommandSwerveDrivetrain.java#L198
    ...
    public void periodic() {
        ...
        // For Advantage Scope
        moduelStatesPublisher.set(getState().ModuleStates);
        targetStatesPublisher.set(getState().ModuleTargets);
    }
