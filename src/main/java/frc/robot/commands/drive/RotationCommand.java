...
public class RotationCommand extends Command {
    ...
    public RotationCommand(Rotation2d theta, Rotation2d omega, RotationalDrivebase driveBase, LocalizerOLD localizer) {
    ...
    public RotationCommand(Rotation2d theta, RotationalDrivebase driveBase, LocalizerOLD localizer) {
